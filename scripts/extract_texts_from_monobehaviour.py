...
# -*- coding: utf-8 -*-
"""
从monobehaviour JSON文件中提取Text-开头文件的m_Text到CSV文件
"""
...
OUTPUT_CSV = os.path.join(RESOURCES_FOLDER, 'text.csv')


def main():
    print("=" * 70)
    print("从 MonoBehaviour JSON 提取 Text m_Text")
    print("=" * 70)
    ...
    # 收集 Text- 开头的JSON文件
    json_files = sorted(Path(MONOBEHAVIOUR_FOLDER).glob('Text-*.json'))
